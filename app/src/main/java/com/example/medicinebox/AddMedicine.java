...
public class AddMedicine extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        lAddTime1 = (LinearLayout) findViewById(R.id.layoutAddTime1);
        lAddTime2 = (LinearLayout) findViewById(R.id.layoutAddTime2);
        lAddTime3 = (LinearLayout) findViewById(R.id.layoutAddTime3);
        lAddTime4 = (LinearLayout) findViewById(R.id.layoutAddTime4);
        lAddTime5 = (LinearLayout) findViewById(R.id.layoutAddTime5);
        btnAddTime1 = (Button) findViewById(R.id.btnAddTime1);
        btnAddTime2 = (Button) findViewById(R.id.btnAddTime2);
        btnAddTime3 = (Button) findViewById(R.id.btnAddTime3);
        btnAddTime4 = (Button) findViewById(R.id.btnAddTime4);
        btnAddTime5 = (Button) findViewById(R.id.btnAddTime5);

        toolbar = (Toolbar) findViewById(R.id.toolbar_addMedicine);
        layoutDay = (LinearLayout) findViewById(R.id.layoutAddDay);
        layoutCycle = (LinearLayout) findViewById(R.id.layoutAddCycle);
        btnDay = (Button) findViewById(R.id.btnType_Day);
        btnCycle = (Button) findViewById(R.id.btnType_Cycle);
        spinCycle = (Spinner) findViewById(R.id.spinnerCycle);
        spinPerDay = (Spinner) findViewById(R.id.spinnerPerDay);
        btnStartdate = (Button) findViewById(R.id.btnStartdate);
        btnSubmit = (Button) findViewById(R.id.btnAddMedSubmit);
        btnCancel = (Button) findViewById(R.id.btnAddMedCancel);
